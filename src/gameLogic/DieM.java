...
public class DieM {
	...
	public TreeMap<Integer, String> initializeFacePictures(){
		facePictures.put(1, "itProjekt"+File.separator+"Dice"+File.separator+"dice_one.png");
		facePictures.put(2, "itProjekt"+File.separator+"Dice"+File.separator+"dice_two.png");
		facePictures.put(3, "itProjekt"+File.separator+"Dice"+File.separator+"dice_three.png");
		facePictures.put(4, "itProjekt"+File.separator+"Dice"+File.separator+"dice_attack.png");
		facePictures.put(5, "itProjekt"+File.separator+"Dice"+File.separator+"dice_heart.png");
		return facePictures;
	}
	
	public TreeMap<Integer, String> initializeFacePicturesLock(){
		facePicturesLock.put(1, "itProjekt"+File.separator+"Dice"+File.separator+"dice_one_ok.png");
		facePicturesLock.put(2, "itProjekt"+File.separator+"Dice"+File.separator+"dice_two_ok.png");
		facePicturesLock.put(3, "itProjekt"+File.separator+"Dice"+File.separator+"dice_three_ok.png");
		facePicturesLock.put(4, "itProjekt"+File.separator+"Dice"+File.separator+"dice_attack_ok.png");
		facePicturesLock.put(5, "itProjekt"+File.separator+"Dice"+File.separator+"dice_heart_ok.png");
