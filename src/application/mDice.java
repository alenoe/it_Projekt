...
import application.mDie;

public class mDice {
	
	public TreeMap<Integer, mDie> diceMap = new TreeMap<Integer, mDie>();
	
	public mDice(int numberOfDice){
		for(int i = 0; i < numberOfDice; i++){
			this.diceMap.put(i, new mDie(i));
		}
	}
	...
	public void rollDice(){
		for (int i = 0; i < this.diceMap.size(); i++){
			mDie tempDie = this.diceMap.get(i);
